...
const BASE_PRODUCT_VARIANTS_URL = '/product-variants/';
const BASE_SPEC_CATEGORIES_URL = '/spec-categories/';
const BASE_SPEC_KEYS_URL = '/spec-keys/';
const BASE_PRODUCT_SPECIFICATIONS_URL = '/product-specifications/';
const BASE_PRODUCT_IMAGES_URL = '/product-images/';
const BASE_PRODUCT_DOCUMENTS_URL = '/product-documents/';
